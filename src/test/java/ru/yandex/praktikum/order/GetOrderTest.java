...
public class GetOrderTest {
    ...
    @Test
    @DisplayName("Получаем все ингредиенты")
    ...
    @Test
    @DisplayName("Получаем все заказы")
    ...
    @Test
    @DisplayName("Получаем заказ авторизованного пользователя")
    ...
    @Test
    @DisplayName("Получаем заказ неавторизованного пользователя")
