...
@Epic("Логин и разлогин пользователя")
public class LoginLogoutUserTest {
    ...
    @Test
    @DisplayName("Логин пользователя по корректным кредам")
    ...
    @Test
    @DisplayName("Разлогин пользователя с корректными кредами")
    ...
    @Test
    @DisplayName("Логин пользователя с пустым имейлом")
